...
bool MainMenuScene::init(SoundController* soundController) {
	...
	auto sprite = Sprite::create("PacmanBackground.png");
	sprite->setPosition(visibleSize / 2);
	auto hei = visibleSize.height / sprite->getContentSize().height;
	sprite->setScale( 0.7,hei);
	...
	labelName->setColor(Color3B::MAGENTA);
	...
	auto gameover = Label::createWithTTF("gameover", "fonts/emulogic.ttf", 30);
	gameover->setPosition(Vec2(visibleSize / 2));
	gameover->setColor(Color3B::MAGENTA);
